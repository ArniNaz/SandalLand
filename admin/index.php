...
session_start();
// koneksi ke db
$koneksi = new mysqli("localhost", "root", "", "sandalland");
...
<head>
    ...
    <title>SandalLand Admin Toko</title>
	<!-- BOOTSTRAP STYLES-->
    ...
    <div id="wrapper">
        <nav class="navbar navbar-default navbar-cls-top " role="navigation" style="margin-bottom: 0">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="index.html">SandalLand admin</a> 
            </div>
  <div style="color: white;
padding: 15px 50px 5px 50px;
float: right;
font-size: 16px;"> Last access : 2 Agustus 2023 &nbsp; <a href="login.php" class="btn btn-danger square-btn-adjust">Logout</a> </div>
        </nav>   
           <!-- /. NAV TOP  -->
